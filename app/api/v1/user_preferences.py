...
from app.schemas.user_preference import SCOPE_PATTERN, UserPreferenceListRead, UserPreferenceRead, UserPreferenceWrite
from app.services import user_preference as user_preference_service
