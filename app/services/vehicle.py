...
from app.models.vehicle import CustodyEventType, Vehicle, VehicleCustodyEvent, VehicleStatus
...
def _validate_reference_fields(db: Session, values: dict[str, Any]) -> None:
    for field in _REFERENCE_FIELDS:
        ...
        if value_code is None:
            continue
        ref_list = reference_data_service.get_reference_list_or_404(db, field)
        reference_data_service.get_reference_value_or_404(db, list_id=ref_list.id, value_code=value_code)
